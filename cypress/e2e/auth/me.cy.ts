...
describe('As a user, I want to handle my account', () => {
  ...
  it('should be able to update my account', () => {
    ...
    cy.getBySel('text-input-first-name')
      .invoke('val')
      .should('eq', existingUser.firstName)
      .clear()
      .type(newUser.firstName)
    cy.getBySel('text-input-last-name')
      .invoke('val')
      .should('eq', existingUser.lastName)
      .clear()
      .type(newUser.lastName)
    cy.getBySel('text-input-pseudo')
      .invoke('val')
      .should('eq', existingUser.pseudo)
      .clear()
      .type(newUser.pseudo)
    cy.getBySel('text-input-date-of-birth')
      .invoke('val')
      .should('eq', existingUser.dateOfBirth)
      .clear()
